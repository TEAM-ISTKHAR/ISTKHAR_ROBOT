...
if ENV:
    ...
    from ISTKHAR_ROBOT.config import Development as Config
...
pbot = Client("ISTKHAR_ROBOT", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN,in_memory=True)
...
from ISTKHAR_ROBOT.modules.helper_funcs.handlers import (
