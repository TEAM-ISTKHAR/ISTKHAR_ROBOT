...
from ISTKHAR_ROBOT.mongo.couples_db import _get_image, get_couple

AVISHA = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ",
            url=f"https://t.me/AvishaXRobot?startgroup=true",
        ),
    ],
]
def dt():
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "ISTKHAR_ROBOT/Love/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "ISTKHAR_ROBOT/Love/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("ISTKHAR_ROBOT/Love/HMMM.jpg")
