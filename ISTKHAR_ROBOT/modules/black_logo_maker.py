...
from ISTKHAR_ROBOT import OWNER_ID, BOT_USERNAME, BOT_NAME
from ISTKHAR_ROBOT import telethn as tbot
from ISTKHAR_ROBOT.modules.nightmode import button_row
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./ISTKHAR_ROBOT/resources/fonts/*")
