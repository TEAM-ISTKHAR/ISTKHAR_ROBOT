import time, re
from ISTKHAR_ROBOT import BOT_USERNAME
from pyrogram.enums import MessageEntityType
from pyrogram import filters
from pyrogram.types import Message
from ISTKHAR_ROBOT import pbot as app
from ISTKHAR_ROBOT.Love.readable_time import get_readable_time
from ISTKHAR_ROBOT.Love.afkdb import add_afk, is_afk, remove_afk
import random 
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup

EVAA = [
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ", url=f"https://t.me/AvishaXRobot?startgroup=true"),
    ],
]
