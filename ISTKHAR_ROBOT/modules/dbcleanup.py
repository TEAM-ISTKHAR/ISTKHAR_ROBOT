...
import ISTKHAR_ROBOT.modules.sql.global_bans_sql as gban_sql
import ISTKHAR_ROBOT.modules.sql.users_sql as user_sql
from ISTKHAR_ROBOT import DEV_USERS, OWNER_ID, dispatcher
